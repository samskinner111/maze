...
class OverCell < Cell 
  ...
  def can_tunnel_north?
    north && north.north && north.horizontal_passage?
  end

  def can_tunnel_south?
    south && south.south && south.horizontal_passage?
  end

  def can_tunnel_east?
    east && east.east && east.horizontal_passage?
  end

  def can_tunnel_west?
    west && west.west && west.horizontal_passage?
  end
